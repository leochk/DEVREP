...
public class TurtleAdapterFactory extends AdapterFactoryImpl {
	...
	protected TurtleSwitch<Adapter> modelSwitch =
		new TurtleSwitch<Adapter>() {
			...
			@Override
			public Adapter caseColouredEntity(ColouredEntity object) {
				return createColouredEntityAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link turtle.ColouredEntity <em>Coloured Entity</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
