...
public class TurtleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TurtlePackage.STAGE: {
				...
				if (result == null) result = caseColouredEntity(stage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TurtlePackage.COLOURED_TURTLE: {
				...
				if (result == null) result = caseColouredEntity(colouredTurtle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TurtlePackage.COLOURED_ENTITY: {
				ColouredEntity colouredEntity = (ColouredEntity)theEObject;
				T result = caseColouredEntity(colouredEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Coloured Entity</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Coloured Entity</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColouredEntity(ColouredEntity object) {
		return null;
	}
